...
public class Vencedor1S extends javax.swing.JFrame {
    ...
    public Vencedor1S() {
      ...
      mi2.setK(exp10.getText());
       ...
       dispose();
                        ...
                        Logger.getLogger(Vencedor1S.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new Vencedor1S().setVisible(true);
