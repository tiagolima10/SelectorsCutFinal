...
public class Round2S extends javax.swing.JFrame {
         ...
         Thread t = new Thread (new Runnable() {
            ...
            public void run() {
                       ...
                       String [] numeros = new String[16];
                                   System.out.println(exp0.getText());
                 System.out.println(exp1.getText());
       System.out.println(exp2.getText());
        System.out.println(exp3.getText());
         System.out.println(exp4.getText());
         System.out.println(exp5.getText());
        System.out.println(exp6.getText());
       System.out.println(exp7.getText());
        System.out.println(exp8.getText());      
          System.out.println(exp9.getText());   
          System.out.println(exp10.getText());    
           System.out.println(exp11.getText());
            System.out.println(exp12.getText());
             System.out.println(exp13.getText());
              System.out.println(exp14.getText());
               System.out.println(exp15.getText());
                System.out.println("");
